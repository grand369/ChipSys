...
public class EmbeddedResourceProvider : IResourceProvider
{
    ...
    public List<TemplatePair> Templates()
    {
        ...
        {
            var sliderResourceName = $"ChipSys.Plugin.Lazy.SlideCaptcha.Core.templates._{i + 1}.slider.png";
            var holeResourceName = $"ChipSys.Plugin.Lazy.SlideCaptcha.Core.templates._{i + 1}.hole.png";
