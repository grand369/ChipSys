...
public class MemberLevelPricePlanService : BaseService, IMemberLevelPricePlanService, IDynamicApi
{
    ...
    public MemberLevelPricePlanService(
    ...
    /// <returns></returns>
    [HttpPost]
    public async Task<long> AddAsync(MemberLevelPricePlanAddInput input)
    {
        // 验证会员等级是否存在
    ...
    /// <param name="input"></param>
    /// <returns></returns>
    public async Task UpdateAsync(MemberLevelPricePlanUpdateInput input)
    {
