...
# 指定项目打包
$projects = (
    "modules\admin\ChipSys.Admin",
    "modules\admin\ChipSys.Admin.Contracts",
    "modules\admin\ChipSys.Admin.Core",
    "platform\ChipSys.ApiUI",
    "platform\ChipSys.Common",
    "platform\ChipSys.DynamicApi",
    "platform\ChipSys.Plugin.Lazy.SlideCaptcha.Core"
)
