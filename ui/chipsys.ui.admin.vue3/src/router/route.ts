      ...
      : [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: '/client/supply-demand',
                name: 'client/supply-demand',
                component: () => import('/@/views/client/supply-demand/index.vue'),
                meta: {
                  title: '供求信息',
                  isLink: '',
                  isHide: false,
              ...
              {
                path: '/client/supplier-application',
                name: 'client/supplier-application',
                component: () => import('/@/views/client/supplier-application/index.vue'),
                meta: {
                  title: '供应商申请',
                  isLink: '',
                  isHide: false,
              ...
              {
                path: '/client/public-query',
                name: 'client/public-query',
                component: () => import('/@/views/client/public-query/index.vue'),
                meta: {
                  title: '公开查询',
                  isLink: '',
                  isHide: false,
              ...
              {
                path: '/client/member-level',
                name: 'client/member-level',
                component: () => import('/@/views/client/member-level/index.vue'),
                meta: {
                  title: '会员等级',
                  isLink: '',
                  isHide: false,
              ...
              },
              {
                path: '/client/inquiry',
                name: 'client/inquiry',
                component: () => import('/@/views/client/inquiry/index.vue'),
                meta: {
                  title: '询价管理',
                  isLink: '',
                  isHide: false,
              ...
              },
              {
                path: '/client/quote',
                name: 'client/quote',
                component: () => import('/@/views/client/quote/index.vue'),
                meta: {
                  title: '报价管理',
                  isLink: '',
                  isHide: false,
